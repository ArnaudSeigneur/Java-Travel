...
public class Requetes {
	...
	public static final String TOUS_LES_VOLS = "SELECT id, dateHeureDepart, dateHeureArrivee, prixEnEuros, compagnie_id, aeroport_depart_id, aeroport_arrivee_id FROM Vol ORDER BY prixEnEuros";
